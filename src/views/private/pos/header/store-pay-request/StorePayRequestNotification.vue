...
<script>
  ...
  import StorePayRequestItem from "@/views/private/pos/header/store-pay-request/StorePayRequestItem";
  import HiddenStorePayRequestDialog
    from "@/views/private/pos/header/store-pay-request/HiddenStorePayRequestDialog";
