<template>
  <el-main class="full-size" v-loading="isLoadingOrder">
    <el-row v-if="!selectedSeat.guid" class="full-size" type="flex" align="middle" justify="center">
    ...
    <el-container v-else class="full-size">
      ...
      <el-main class="full-size">
        <el-row class="full-size" type="flex" align="middle" justify="center">
          <qrcode v-if="selectedSeat.orderGuid" :value="seatPrefixUrl + selectedSeat.guid + '?' + seatResumeParam + '=' + selectedSeat.orderGuid"
                  :options="{ width: 350 }">
          </qrcode>
          <qrcode v-else :value="seatPrefixUrl + selectedSeat.guid"
                  :options="{ width: 350 }">
          </qrcode>
        </el-row>
      </el-main>
      ...
      <el-footer height="auto" class="padding-bottom-20">
        <el-row type="flex" justify="center" align="middle">
          <el-button @click="goto(selectedSeat.guid, currentOrder.guid)" type="warning">Mở liên kết trong QR</el-button>
        </el-row>
      </el-footer>
    </el-container>
  </el-main>
